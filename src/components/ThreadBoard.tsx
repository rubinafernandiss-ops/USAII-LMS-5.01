...
function Composer({
  ...
  const [audience, setAudience] = useState<'everyone' | 'instructor'>(staff ? 'everyone' : 'instructor');
  ...
  useEffect(() => {
    if (open) {
      ...
      setAudience(staff ? 'everyone' : 'instructor');
    }
    ...
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <Input value={title} onChange={(e) => setTitle(e.target.value)} placeholder={staff ? 'Reminder: module 2 quiz closes Friday' : 'How do I tell if an AI answer is reliable?'} />
