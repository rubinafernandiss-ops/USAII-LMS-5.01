import { Activity, BookMarked, ClipboardCheck, CreditCard, Gauge, MessageCircle, Users, UsersRound } from 'lucide-react';
...
import { Overview, Payments } from './Admin';
...
/**
 * One portal for one instructor. This account teaches *and* runs the institute:
 * courses, pricing, accounts, payments and reports all live here.
 */
export default function StaffApp() {
  const { view, params, query } = useRoute();
  const [open, setOpen] = useState(0);

  // Badge: learner questions still waiting for an answer.
  useEffect(() => {
    let alive = true;
    const load = () =>
