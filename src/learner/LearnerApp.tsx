...
import { ArrowRight, GripVertical, BarChart3, BookOpen, Compass, HelpCircle, LayoutDashboard, MessageCircle, MessageSquareHeart, Navigation, Sparkles, Trophy, X } from 'lucide-react';
...
function Routes() {
  ...
  const { home, active, learner } = useLearner();
  ...
  switch (v) {
    ...
    case 'explore':
      ...
      break;
    case 'enroll':
      page = <Checkout courseId={params[0] ?? ''} user={learner} bare />;
      break;
    case 'ask':
