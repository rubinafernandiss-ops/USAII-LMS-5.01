...
authRouter.post(
  ...
  wrap((req) => {
    ...
    if (!user!.active) fail(403, 'This account has been deactivated. Contact USAII® support.');
    clearFailures(email);
...
// Learners register by enrolling and paying on the public Explore Courses page (see routes/catalog.ts).
