...
export function seedDatabase(): Database {
  ...
  // One instructor account runs both the teaching and the institute.
  ...
  const audit: AuditEntry[] = [
    ...
    { id: uid('au'), at: at(21, 9), actorId: 'u_instructor', actorName: 'Dr. Patricia Okonkwo', role: 'instructor', action: 'PUBLISH_COURSE', details: 'Published the AI Productivity Micro-Credential to the public catalog.' },
  ];
