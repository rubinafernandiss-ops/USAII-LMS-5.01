...
export function computeRecommendations(args: {
  ...
  if (prediction.passConfidence < 70 && prediction.evidence !== 'none') {
    recs.push({
      id: `ask-${cid}`,
      priority: 'soon',
      title: 'Ask your instructor about the topic you find hardest',
      detail: 'Your chance of passing is below 70%. One clear question is usually the quickest way to get unstuck.',
      minutes: 10,
      action: { kind: 'thread', courseId: cid },
    });
  }
